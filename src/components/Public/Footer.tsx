         ...
         <div className='flex justify-between gap-3'>
            ...
            <div className='flex-1'>
               ...
               <div className='mt-5'>
                  ...
                  <p className='text-[#7A7E9A] leading-6 text-sm mt-2'>141 Chiến Thắng, Tân Triều, Thanh Trì, Hà Nội</p>
               </div>
               <div className='mt-5'>
                  <div className='flex items-center gap-2 text-green'><IoCallOutline size={20} /> <span>CALL</span></div>
                  <p className='text-[#7A7E9A] leading-6 text-sm mt-2'>0968250720</p>
               </div>
